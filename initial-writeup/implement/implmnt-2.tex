...
\begin{figure}[h!]
  \centering
  \includegraphics[width=15cm,height=12cm,keepaspectratio]{../media/crawler/fingerprinting.png}
  \caption{fingerprinting documents to avoid de-duplication}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=15cm,height=8cm,keepaspectratio]{../media/crawler/shingles.png}
  \caption{near-duplicate detection using shingling}
